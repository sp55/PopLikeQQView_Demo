...
@interface PopLikeQQView ()<UITableViewDelegate,UITableViewDataSource>
@end


@implementation PopLikeQQView
...
{
    PopLikeQQView *popupMenu = [[PopLikeQQView alloc] initWithTitles:titles icons:icons menuWidth:itemWidth delegate:delegate];
